...
-- Q5) Display the Supplier details of who can supplying more than one product.
...
select category.CAT_ID,category.CAT_NAME,product.PRO_NAME,min(supplier_pricing.SUPP_PRICE) AS Price_Of_Product
...
-- Result 4
# CAT_ID, CAT_NAME, PRO_NAME, Price_Of_Product
...
-- Q9) 1)	Create a stored procedure to display supplier id, name, Rating(Average rating of all the products sold by every customer) and Type_of_Service. For Type_of_Service, If rating =5, print “Excellent Service”,If rating >4 print “Good Service”, If rating >2 print “Average Service” else print “Poor Service”.
DELIMITER &&  
...
call proc();
-- Result 7
-- # supp_id, supp_name, Average, Type_of_Service
